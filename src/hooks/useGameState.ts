...
import {CROPS, INITIAL_GOLD, INITIAL_PLOTS_COUNT, MAX_PLOTS_COUNT, SKINS, XP_PER_LEVEL} from '../constants';
import type {
  ActiveBuff,
  CropType,
  Decoration,
...
export const migrateGameState = (value: unknown): GameState => {
  ...
  return {
    ...
    inventory: Array.isArray(value.inventory)
      ...
      : defaults.inventory,
    activeSkin: isSkinId(value.activeSkin) ? value.activeSkin : defaults.activeSkin,
