...
import {CROPS, SKINS_CONFIG, type SkinId} from '../constants';
...
export const Plot: React.FC<PlotProps> = ({
  ...
  const skinPlotClass = SKINS_CONFIG[activeSkin].plotClass;
  ...
  return (
    <motion.div
      ...
      className={`${slotStyle} ${skinPlotClass} ${slotToneClass} ${
