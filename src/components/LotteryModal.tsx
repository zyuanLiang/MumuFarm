...
import type {LotterySessionResult, PrizePoolItem, SkinId} from '../types';
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        {backgroundTheme.bgImage ? (
          ...
          <motion.div
            ...
            style={{
              background: `linear-gradient(180deg, ${backgroundTheme.secondary} 0%, ${backgroundTheme.color} 100%)`,
